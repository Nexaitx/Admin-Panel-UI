...
@Component({
  selector: 'app-vitoxyz-available-products',
  imports: [
     MatIconModule,
    MatTableModule,
    MatSortModule,
  ...
  templateUrl: './vitoxyz-available-products.html',
  styleUrl: './vitoxyz-available-products.scss'
})
export class VitoxyzAvailableProducts {
