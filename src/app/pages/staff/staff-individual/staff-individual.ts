...
export class StaffIndividual implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor() {
   ...
   private setupRealTimeStaffUpdates(): void {
    ...
    // Firebase service में callback register करें
  ...
  // ✅ NEW: Update data source efficiently
  ...
  // ✅ NEW: Show real-time update notifications
  ...
  // ✅ NEW: Check if should auto-open new staff
